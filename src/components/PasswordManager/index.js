...
class PasswordManager extends Component{
    ...
    deletePasswordRecord=id=>{
        ...
        const filteredRecords=passwordRecords.filter(each=>each.id !== id)
        this.setState({passwordRecords:filteredRecords})
    }

    getSearchRecords=()=>{
        const {passwordRecords,searchInput}=this.state 
        const searchedRecords=passwordRecords.filter(eachRecord=>eachRecord.url.toLowerCase().includes(searchInput.toLocaleLowerCase()))
